...
public class FileInfoServiceTest {
    ...
    void init() throws IOException {
        ...
        image2 = new MockMultipartFile("file", "test.png", MediaType.IMAGE_PNG_VALUE, new FileInputStream(new File("C:/test2.png")));
    ...
    void infoTest(){
        assertDoesNotThrow(()->{
            ...
            //fileInfos.get(0).getSeq())
            //fileInfos.get(0).getGid()), fileInfos.get(0).getLocation())
            service.get(fileInfos.get(0).getSeq());
            service.getFilePath(fileInfos.get(0));
        });
    }
}